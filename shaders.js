...
const fsSource = `#version 300 es
    ...
    float get_clouds(vec3 p,float intensity) {
        ...
        float clouds = texture(_Clouds,vec2(x+r.x+_Time*0.0002,y)).r+texture(_Clouds,vec2(x+r.y-_Time*0.0001,y)).r+texture(_Clouds,vec2(x+r.z,y)).r;
    ...
    float get_clouds_blurred(vec3 p,float intensity) {
        ...
        y = y/3.1415+0.5;
        vec3 r = hash(vec3(1,1,1));
        float clouds = texture(_CloudsBlurred,vec2(x+r.x+_Time*0.0002,y)).r+texture(_CloudsBlurred,vec2(x+r.y-_Time*0.0001,y)).r+texture(_CloudsBlurred,vec2(x+r.z,y)).r;
